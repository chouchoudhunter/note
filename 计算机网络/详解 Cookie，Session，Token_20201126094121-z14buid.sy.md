...
2. Session复制：任何一个服务器上的 Session 发生改变（增删改），该节点会把这个 Session 的所有内容序列化，然后广播给所有其它节点。![SessionCopy](https://user-gold-cdn.xitu.io/2019/6/13/16b4fb158be01294?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
3. 共享Session：将Session Id 集中存储到一个地方，所有的机器都来访问这个地方的数据。这种方案的优点是架构清晰，缺点是工程量比较大。另外，持久层万一挂了，就会单点失败；![session共享](https://user-gold-cdn.xitu.io/2019/6/13/16b4fb158bbf763c?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
